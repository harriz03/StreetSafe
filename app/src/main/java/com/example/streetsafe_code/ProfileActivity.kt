            ...
            FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener { document ->
                    ...
                    if (document.exists()) {
                        ...
                        val email =
                            document.getString("email") ?: "No email"

                        val reportsCount =
                            document.getLong("reportsCount") ?: 0

                        findViewById<TextView>(R.id.txtProfileName)
                            .text = username

                        findViewById<TextView>(R.id.txtProfileUsername)
                            .text = username

                        findViewById<TextView>(R.id.txtProfileEmail)
                            .text = email

                        findViewById<TextView>(R.id.txtProfileEmailField)
                            .text = email

                        findViewById<TextView>(R.id.txtReportsCount)
